...
export function SuperAdminDashboard({ onSignOut }: SuperAdminDashboardProps) {
  ...
  // Loading states
  const isLoadingUsers = organizersJudges === undefined;
  ...
  if (isLoadingUsers || isLoadingEvents || isLoadingStats) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-space-navy via-charcoal to-dark-blue flex items-center justify-center">
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-accent-blue mx-auto mb-4"></div>
          <h3 className="text-xl font-bold text-silver mb-2">Loading Super Admin Dashboard...</h3>
          <p className="text-silver/70">Please wait while we fetch all system data</p>
        </div>
      </div>
    );
  }

...
export function ParticipatingInstitutionsManager() {
  ...
  // Loading states
  const isLoadingInstitutions = institutions === undefined;
    ...
    return (
      <div className="p-4">
        ...
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 text-center">
          ...
          <h3 className="text-xl font-bold text-silver mb-2">Loading Institutions...</h3>
          <p className="text-silver/70">Please wait while we fetch the participating institutions</p>
        </div>
      </div>
    );
  }

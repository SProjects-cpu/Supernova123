...
interface EventSelectionModalProps {
  ...
  events?: any[]; // Preloaded events
}

export function EventSelectionModal({ onClose, onEventSelect, events }: EventSelectionModalProps) {
  // Use preloaded events instead of fetching
        ...
        <div className="p-4 sm:p-6 overflow-y-auto max-h-[70vh]">
          {!events ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-bold text-silver mb-2">Loading Events...</h3>
              <p className="text-silver/70">Please wait while we fetch the latest events</p>
            </div>
